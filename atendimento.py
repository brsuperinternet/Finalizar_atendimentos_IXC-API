...
planilha = openpyxl.load_workbook('atendimentos.xlsx')   # faz o dowload da planilha Excel com os atendimentos 
...
for id in id_a_editar:
    payload = {
        ...
        'mensagens_nao_lida_cli': 'Finalizado via API devido erro no fluxo do processo',
        "operador": "",
